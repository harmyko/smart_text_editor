...
public class EditorTest {
    ...
    private static JComboBox<String> editorTypeComboBox;
    private static JProgressBar progressBar;
    private static JLabel statusLabel;

    private static Editor currentEditor;
    private static EditorFactory spellCheckFactory;
    private static EditorFactory translateFactory;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(EditorTest::createAndShowGUI);
    }
    ...
    private static Editor resetEditor() {
        String selectedType = (String) editorTypeComboBox.getSelectedItem();
        if ("SpellCheck Editor".equals(selectedType)) {
